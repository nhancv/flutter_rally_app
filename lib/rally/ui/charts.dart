...
class CircleChartPainter extends CustomPainter {
	...
	void paint(Canvas canvas, Size size) {
		...
		final Rect rect = EdgeInsets.all(strokeWidth * 0.5)
		...
		final double dividerSweep = ((math.pi * 2) / size.longestSide) * strokeWidth * 0.25;
	...
	@override
	bool shouldRepaint(CircleChartPainter oldDelegate) => oldDelegate.accountSet != accountSet;
}